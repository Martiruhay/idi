...
QT_MOC_LITERAL(1, 11, 10), // "enviaValor"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4) // "zoom"

    },
    "MyGLWidget\0enviaValor\0\0zoom"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyGLWidget::*_t)(const int & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::enviaValor)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::enviaValor(const int & _t1)
{
